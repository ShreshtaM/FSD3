...
export class CartitemComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let url4 = `http://b8java28.iiht.tech:3000/findcustomerid/` + this.cid;
    fetch(url4, {
      method: "GET",
      headers: {
        "content-type": "application/json"
    ...
    for (var i of this.List5) {
      console.log(i);
      let url5 = `http://b8java28.iiht.tech:3000/showproductbyid/` + i
      fetch(url5, {
        method: "GET",
        headers: {
          "content-type": "application/json"
  ...
  deleteitem(pid: any) {
    let url = "http://b8java28.iiht.tech:3000/deleteitem/" + pid + "/" + this.cid;
    fetch(url, {
      method: "GET",
      headers: {
        "content-type": "application/json"
  ...
  checkout() {
    ...
    for (let i of this.List) {
      ...
      let url = "http://b8java28.iiht.tech:3000/savecart/" + this.cid + "/" + productid + "/" + quantity;
      fetch(url, {
        method: "GET",
        headers: {
          "content-type": "application/json"
