  ...
  ngOnInit() {
    ...
    fetch(url, {
      ...
      .then(data => {
        ...
        //this.myFullresImage="https://raw.githubusercontent.com/demanda1/Project/master/images/mahindra-scorpio1.png";
        this.myThumbnail = data[0].productimage;
        //this.myThumbnail = "https://raw.githubusercontent.com/demanda1/Project/master/images/mahindra-scorpio1.png";
      })
